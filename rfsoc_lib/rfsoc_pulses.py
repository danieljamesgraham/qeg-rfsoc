...
class RfsocPulses():
    ...
    def __init__(self, imported_seqs, calibration=None, ch_map=None, gains={}, delays={}, iq_mix=False, print_params=False):
        ...
        calibration : object, optional
            Multi-DAC IQ mixing calibrated gains and phases.
        ...
        for ch, seq_params in pulse_seqs.items():
            ...
            for params in seq_params:
                if isinstance(params, tuple): # Regular pulse
                    ...
                    length_ns = params[0]
                    self.assign_pulse_params(params, ch, time, calibration, iq_mix)
                else: # Arb. pulse
        ...
        self.print_params(print_params, iq_mix)
    ...
    def assign_pulse_params(self, params, ch, time, calibration, iq_mix):
        """
        ...
        calibration : object
            Multi-DAC IQ mixing calibration amplitudes and phases.
        iq_mix : bool
            DAC_A lags DAC_B by 90 degrees for IQ mixing.
        """
            ...
            if self.ch_cfg[ch]["ch_type"] == "DAC":
                ...
                if self.ch_cfg[ch]["calibrated"]:
                    ...
                    if calibration.abs_gain:
                        print(f"WARNING: User-specified gain for {ch} is ignored when constant power calibration is used.")
    ...
    def print_params(self, enabled, iq_mix):
        """
