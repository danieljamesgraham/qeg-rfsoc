...
class RfsocPulses():
    ...
    def assign_arb_params(self, params, ch, time):
        ...
        # TODO: Custom gain
        if self.const_power is None:
            self.pulses[ch]["gains"].append(int(self.scale_power * self.ch_cfg[ch]["gain"]*2))
        else:
            self.pulses[ch]["gains"].append(int(self.interpolate_dict(self.const_power, params.freq*1e3)*2))
